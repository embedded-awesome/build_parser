...
class Kconfig(object):
    ...
    def _init(self, filename, warn, warn_to_stderr, encoding):
        ...
        try:
            module_name = os.getenv("KCONFIG_FUNCTIONS", "kconfigfunctions")
            if module_name == "kconfigfunctions" and __package__:
                module_name = ".kconfigfunctions"
            self._functions.update(
                importlib.import_module(module_name, package=__package__).functions)
        except ImportError:
            pass
    ...
    def _fn_val(self, args):
        ...
        raise KconfigError("{}:{}: unknown function {} in macro expansion"
                               .format(self.filename, self.linenr, fn))
    ...
    def _parse_block(self, end_token, parent, prev):
        ...
        while self._next_line():
            ...
            if t0 in [_T_CONFIG, _T_MENUCONFIG, _T_CONFIGDEFAULT]:
                ...
                filenames += sorted(iglob(join(dirname(self.filename), pattern)))
